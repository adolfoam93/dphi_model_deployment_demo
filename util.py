...
def get_model_prediction(ap_income, coap_income, loan_amt, loan_amt_term, credit_hist, gender, education, married_status, dependents, self_employed, property_area):
...
def load_saved_artifacts():
    ...
    with open("./server/artifacts/final_model.pickle", "rb") as f:
